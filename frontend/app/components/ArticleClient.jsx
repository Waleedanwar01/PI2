...
export default function ArticleClient({ slug }) {
  ...
  useEffect(() => {
    if (blog?.title) {
      ...
      document.title = `${blog.title} | AutoInsurance.org`;
      ...
      <section className="mb-16">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <nav className="flex items-center justify-center text-sm text-gray-500 mb-6">
            ...
            {blog.category && <span className="text-orange-600 font-medium">{blog.category}</span>}
          </nav>

          {/* Category Badge */}
          {blog.category && (
            <div className="mb-6">
              <span className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-orange-100 to-orange-200 text-orange-800 text-sm font-semibold shadow-sm">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="w-10 h-10 bg-blue-700 text-white rounded-full hover:bg-blue-800 transition-colors flex items-center justify-center"
...
<div className="max-w-4xl mx-auto">
  ...
  <article
    ref={articleRef}
    className="prose prose-lg md:prose-xl max-w-none prose-headings:tracking-tight prose-h1:text-gray-900 prose-h2:text-gray-900 prose-p:leading-relaxed prose-p:text-gray-800 prose-a:text-orange-600 hover:prose-a:text-orange-700 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-img:rounded-2xl prose-img:shadow-lg prose-code:bg-gray-100 prose-code:text-gray-800 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-blockquote:border-l-4 prose-blockquote:border-orange-300 prose-blockquote:pl-6 prose-blockquote:text-gray-700 prose-hr:border-orange-200"
  >
        ...
        <section className="mt-20 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            {(blog.author || blog.author_image) && (
              <div className="group">
                <div className="bg-gradient-to-br from-orange-50 via-white to-orange-100/30 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-orange-200 relative overflow-hidden">
                  {/* Background decoration */}
                  <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-orange-200/50 to-transparent rounded-full transform translate-x-10 -translate-y-10"></div>
                  ...
                  <div className="text-center relative z-10">
                    <div className="relative mb-6">
                      {blog.author_image ? (
                        <img
                          ...
                          className="h-28 w-28 rounded-full object-cover border-4 border-orange-300 mx-auto shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105"
                          alt="Author"
                        />
                      ) : (
                        <div className="h-28 w-28 rounded-full bg-gradient-to-r from-orange-300 to-orange-400 flex items-center justify-center mx-auto shadow-lg group-hover:shadow-xl transition-all duration-300">
                          <svg className="w-14 h-14 text-orange-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                          </svg>
                        </div>
                      )}
                      <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-200 to-orange-300 rounded-full shadow-sm">
                        <svg className="w-4 h-4 mr-2 text-orange-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                        <span className="text-sm font-bold text-orange-800">Content Writer</span>
                      </div>
                    </div>
                  ...
                  <div className="text-center relative z-10">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-200 to-blue-300 rounded-full shadow-sm">
                        ...
                        <span className="text-sm font-bold text-blue-800">Expert Reviewer</span>
                      </div>
                    </div>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-full shadow-sm">
              ...
              <span className="text-sm font-semibold text-green-800">Verified & Trusted Content</span>
            </div>
          </div>
        </section>
      )}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      {blog.author && (
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-6 border-2 border-orange-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-orange-800 text-lg">Written by</h4>
              <p className="text-orange-700 font-semibold">{blog.author}</p>
            </div>
          </div>
        </div>
      )}
      ...
      {blog.reviewer && (
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-6 border-2 border-blue-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-blue-800 text-lg">Reviewed by</h4>
              <p className="text-blue-700 font-semibold">{blog.reviewer}</p>
            </div>
          </div>
        </div>
      )}
      ...
      {related.length > 0 && (
        <section className="mt-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Related Articles</h3>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Continue learning about auto insurance</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {related.map((it) => (
              <article
                key={String(it.slug || '')}
                className="group bg-white rounded-2xl shadow-lg border border-gray-200 hover:shadow-2xl hover:border-orange-200 transition-all duration-300 overflow-hidden transform hover:-translate-y-2"
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    {it.category && (
                      <span className="px-3 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-orange-100 to-orange-200 text-orange-800 shadow-sm">
                        {it.category}
                      </span>
                    )}
                    {it.created_at && (
                  ...
                  <h4 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-orange-700 transition-colors line-clamp-2 leading-tight">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-400">
                      ...
                      <span className="font-medium">~{Math.ceil((it.summary?.length || 0) / 200) + 2} min read</span>
                    </div>
                  </div>
                </div>
              </article>
          ...
          <div className="text-center mt-12">
            <Link
              href="/articles"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-700 text-white font-semibold rounded-xl hover:from-orange-700 hover:to-orange-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              View All Articles
